...
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('UPTIME', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_UPTIME'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('VERSION', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_VERSION'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('HELP', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_HELP'), 0, 1, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('DELETEMESSAGES', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_DELETEMESSAGES'), 1, 0, 1, 11264);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('ALIAS', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_ALIAS'), 2, 0, 1, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('PREFIX', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_PREFIX'), 1, 0, 1, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('JOIN', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_JOIN'), 0, 0, 0, 1051648);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('LEAVE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_LEAVE'), 0, 0, 0, 1051648);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('PLAY', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_PLAY'), 1, -1, 0, 3148800);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('QUEUE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_QUEUE'), 0, 0, 0, 3136);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('SKIP', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_SKIP'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('LOOPQUEUE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_LOOPQUEUE'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('NOWPLAYING', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_NOWPLAYING'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('CLEAR', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_CLEAR'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('RESUME', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_RESUME'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('PAUSE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_PAUSE'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('VOLUME', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_VOLUME'), 1, 0, 1, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('TOGGLECOMMAND', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_TOGGLECOMMAND'), 1, 0, 1, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('SHUFFLE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_SHUFFLE'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('REMOVE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_REMOVE'), 1, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('MOVE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_MOVE'), 2, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('JUMPTO', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_JUMPTO'), 1, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('ONJOINROLE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_ONJOINROLE'), 1, 0, 1268438528);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('FLIP', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_FLIP'), 0, 0, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('TEAMS', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_TEAMS'), 3, -1, 0, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('UPDATEYTTOKEN', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_UPDATEYTTOKEN'), 2, 0, 2, 3072);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('VOTE', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_VOTE'), 1, -1, 0, 3136);
INSERT INTO `command` (`name`, `description`, `paramCount`, `optionalParams`, `level`, `minPermission`) VALUES ('BIND', (SELECT `îd` FROM `localisation` WHERE `name` = 'COMMAND_DESC_BIND'), 2, 0, 1, 3072);

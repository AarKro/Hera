...
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('UPTIME', 'Checks how long Hera has been up and running', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('VERSION', 'Displays current version number', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('HELP', 'Shows this Help page', 0, 1, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('DELETEMESSAGES', 'Deletes the newest channel messages', 1, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('ALIAS', 'Creates an alias for a command that works in only the current guild.', 2, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('PREFIX', 'Sets command prefix', 1, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('JOIN', 'Makes Hera join the voice channel you are currently connected to', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('LEAVE', 'Makes Hera leave the voice channel she is currently connected to', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('PLAY', 'Plays/Queues a song from a link / a few keywords to search on YouTube', 1, -1, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('QUEUE', 'Display the songs currently in the queue', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('SKIP', 'Skip the current song', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('LOOPQUEUE', 'Toggle loop queue mode', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('NOWPLAYING', 'Display the currently playing song', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('CLEAR', 'Clear the music queue', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('RESUME', 'Resume the music player', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('PAUSE', 'Pause the music player', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('VOLUME', 'Sets volume for music player', 1, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('TOGGLECOMMAND', 'Toggles if a command is enabled or not', 1, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('SHUFFLE', 'Shuffles the queue', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('REMOVE', 'Removes a song from the queue', 1, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('MOVE', 'Move a song to a new queue index', 2, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('JUMPTO', 'Jump to an index of the queue', 1, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('ONJOINROLE', 'Sets a role to use on join', 1, 0, 1);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('FLIP', 'Flips a coin', 0, 0, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('TEAMS', 'Makes teams from the specified parameters', 3, -1, 0);
INSERT INTO `command` (`name`, `description`, `paramCount`, `infiniteParam`, `level`) VALUES ('UPDATEYTTOKEN', 'Sets the youtube tokens to a new value', 2, 0, 2);
...
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'PLAY'), 'P');
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'QUEUE'), 'Q');
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'NOWPLAYING'), 'NP');
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'LOOPQUEUE'), 'LQ');
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'CLEAR'), 'CLR');
INSERT INTO `alias` (`commandFK`, `alias`) VALUES ((SELECT MIN(`id`) FROM `command` WHERE `name` = 'DELETEMESSAGES'), 'DELMSG');